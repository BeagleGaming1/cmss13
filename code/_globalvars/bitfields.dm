...
DEFINE_BITFIELD(cooking_flags, list(
	"COOKING_TYPE_MICROWAVE" = COOKING_TYPE_MICROWAVE,
	"COOKING_TYPE_OVEN" = COOKING_TYPE_OVEN,
	"COOKING_TYPE_GRILL" = COOKING_TYPE_GRILL,
	"COOKING_TYPE_GRIDDLE" = COOKING_TYPE_GRIDDLE,
	"COOKING_TYPE_STOVE" = COOKING_TYPE_STOVE,
	"COOKING_TYPE_CAMPFIRE" = COOKING_TYPE_CAMPFIRE,
	"COOKING_TYPE_PROCESSOR" = COOKING_TYPE_PROCESSOR,
	"COOKING_TYPE_ALL_RECIPES" = COOKING_TYPE_ALL_RECIPES
))
